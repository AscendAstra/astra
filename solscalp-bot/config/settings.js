...
export function loadSettings() {
  ...
  return {
    ...
    scalp_entry_mc_max:             parseFloat(process.env.SCALP_ENTRY_MC_MAX        || '420000'),
    scalp_exit_mc:                  parseFloat(process.env.SCALP_EXIT_MC             || '800000'),
    ...
    scalp_interval_ms:              parseInt(process.env.SCALP_INTERVAL_MS           || '300000'),

    // ── MOMENTUM STRATEGY ───────────────────────────────────────────
    momentum_enabled:               process.env.MOMENTUM_ENABLED !== 'false',
    momentum_entry_mc_min:          parseFloat(process.env.MOMENTUM_ENTRY_MC_MIN     || '100000'),
    momentum_entry_mc_max:          parseFloat(process.env.MOMENTUM_ENTRY_MC_MAX     || '150000'),
    momentum_exit_mc_min:           parseFloat(process.env.MOMENTUM_EXIT_MC_MIN      || '250000'),
    momentum_exit_mc_max:           parseFloat(process.env.MOMENTUM_EXIT_MC_MAX      || '300000'),
    momentum_volume_multiplier:     parseFloat(process.env.MOMENTUM_VOLUME_MULT      || '2'),
    ...
    momentum_interval_ms:           parseInt(process.env.MOMENTUM_INTERVAL_MS        || '300000'),

    // ── BREAKOUT STRATEGY ───────────────────────────────────────────
    breakout_enabled:               process.env.BREAKOUT_ENABLED !== 'false',
    breakout_entry_mc_min:          parseFloat(process.env.BREAKOUT_ENTRY_MC_MIN     || '5000000'),
    breakout_entry_mc_max:          parseFloat(process.env.BREAKOUT_ENTRY_MC_MAX     || '20000000'),
    breakout_volume_multiplier:     parseFloat(process.env.BREAKOUT_VOLUME_MULT      || '2'),
    breakout_min_5m_pump:           parseFloat(process.env.BREAKOUT_MIN_5M_PUMP      || '10'),
    ...
    breakout_stop_loss_percent:     parseFloat(process.env.BREAKOUT_STOP_LOSS        || '20'),
    breakout_target_gain_percent:   parseFloat(process.env.BREAKOUT_TARGET_GAIN      || '30'),
    breakout_interval_ms:           parseInt(process.env.BREAKOUT_INTERVAL_MS        || '300000'),
